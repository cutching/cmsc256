...
public class Triangle  {
   ...
   public Triangle(double aIn, double bIn, double cIn) {
      ...
      if (sideA <= 0 || sideB <= 0 || sideC <= 0) {
         throw new IllegalArgumentException("Sides: " + sideA + " " + sideB + " " + sideC
            + " sides cannot be <= 0.");       // add an explanation why this exception is being thrown.
      }
      if ((sideA >= sideB + sideC) || (sideB >= sideA + sideC) || (sideC >= sideA + sideB)) {
         throw new IllegalArgumentException("Sides: "
            + sideA + " " + sideB + " " + sideC
            + " one side cannot be >= the sum of the remaining two sides.");      // add an explanation why this exception is being thrown.
      }
   }
   ...
   public String classify() {
      ...
      else if(sideA == sideB && sideA != sideC || sideB == sideC && sideA != sideB || sideC == sideA && sideC != sideB){
         result = "isosceles";
      }
